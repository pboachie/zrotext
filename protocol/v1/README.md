...
[inbound-foundation.md](inbound-foundation.md) defines the signed inbound storage and outbox contract. [inbound-pilot-budgets.md](inbound-pilot-budgets.md) sets the per-device and per-account storage budgets for pilot inbound events. Optional inbound frames and webhook delivery have separate configuration and contracts.
