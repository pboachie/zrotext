...
This slice has no Checkout or Portal route, live Stripe test account exercise,
customer-binding UI, price-to-quota policy, payment grace rules, downgrade
...
[Invoice](https://docs.stripe.com/api/invoices/object) objects; they do not
