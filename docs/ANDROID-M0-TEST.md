...
2. On the dedicated Samsung selected for initial support, install the signed test APK, grant requested permissions, select the active SIM, enter a short-lived WSS test token and start gateway mode. Record any FGS start failure or permission prompt behavior. The founder waived the Pixel requirement for initial scope on 2026-09-22; test other devices and OS versions before expanding support claims.
...
|---|---|---|---|---|---|---|---|
| Samsung SM-S928U / Android 16 API 36 — APK launch, permissions, one SIM and selection verified | SIM identity private; carrier untested | unverified | unverified | unverified | unverified | unverified | unverified |
